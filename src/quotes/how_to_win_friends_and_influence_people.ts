...
const data: Quotes[] = [
    new Quotes (
        ...
        [
            ...
            "[Win People to Your Way of Thinking ] 0. Appeal to the nobler motives.",
            "[Win People to Your Way of Thinking ] 1. Dramatize your ideas.",
            "[Win People to Your Way of Thinking ] 2. Throw down a challenge.",
    ...
    new Quotes (
        ...
        [
            ...
            "[상대방을 설득하는 방법 ] 0. 보다 고매한 동기에 호소하라",
            "[상대방을 설득하는 방법 ] 1. 당신의 생각을 극적으로 표현하라",
            "[상대방을 설득하는 방법 ] 2. 모든 방법이 소용 없을 때 사용하는 방법 - 도전 의욕을 불러일으켜라",
