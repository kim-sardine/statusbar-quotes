...
const data: Quotes[] = [
    ...
    },
    {
        ...
        sentences: [
            ...
            "건강한 몸에서 건강한 코드가!",
            "게으름은 개발자의 가장 좋은 친구이다. 한 번에 자동화할 수 있는 것을 두 번 하지 마라.",
            "나는 대단한 프로그래머는 아니다. 그저 훌륭한 습관들을 가지고있는 평범한 프로그래머일 뿐이다. - Kent Beck",
            ...
            "세상에는 10 가지 분류의 사람이 있다. Binary 를 아는 사람과 모르는 사람.",
