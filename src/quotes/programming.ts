...
const data: Quotes[] = [
    ...
    },
    {
        ...
        sentences: [
            ...
            "나는 대단한 프로그래머는 아니다. 그저 훌륭한 습관들을 가지고있는 좋은 프로그래머일 뿐이다. - Kent Beck",
            "나쁜 코드를 주석처리하고 넘어가버리면 안된다. 재작성하라. - Brian Kernighan",
            ...
            "컴퓨터는 원래 엄청 빠르다. 프로그래머가 느리게 만들뿐이다.",
            ...
            "형편없는 프로그래머가 언어를 탓한다.",
            "훌륭한 코드가 훌륭한 문서보다 낫다. - Steve McConnell",
        ]
    }
];
