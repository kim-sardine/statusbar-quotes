...
const data: Quotes[] = [
    ...
    },
    {
        ...
        sentences: [
            ...
            "건강한 몸에서 건강한 코드가!",
            "게으름은 개발자의 가장 좋은 친구이다. 자동화 될 수 있는 것들에 시간을 낭비하지 마라.",
            ...
            "새로운 기술이 번져가기 시작하면, 최소한 그 배경과 그 기술의 작동 원리를 이해할 필요는 있다. 세부적인 사항은 그 기술이 요구사항을 해결하는 데 도움이 될 때 파악해도 늦지 않다. 오래된 도구로는 새로운 문제를 해결할 수 없을 수 있다. 계속해서 새로운 기술를 익혀나가야 한다.",
            ...
            "컴퓨터는 원래 엄청 빠르다. 프로그래머가 느리게 만들었을 뿐이다.",
            "코드 라인수를 기준으로 프로그램의 진도를 측정하는 것은 비행기 제작 진도를 무게로 측정하는 것과 같다. - Bill Gates",
            "프로그램은 사람이 읽기 위해 작성되는 것이다. 그러다 우연히 컴퓨터에 의해 실행되는것 뿐이다. - Harold Abelson",
