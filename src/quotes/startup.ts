...
const data: Quotes[] = [
    ...
    },
    {
        ...
        sentences: [
            ...
            "가장 불만스러워 하는 고객이 배움의 가장 좋은 원천이다. - 빌 게이츠",
            ...
            "당신이 내놓은 첫번째 상품에 부끄럽지 않다면, 당신은 너무 늦게 런칭한 것이다. - Reid Hoffman",
            "당신이 배를 만들고 싶다면, 사람들에게 목재를 가져오게 하는 등 일을 지시하지 말라. 대신 그들이 저 넓고 끝없는 바다에 대한 동경심을 가지게 만들어라. - 생텍쥐페리",
